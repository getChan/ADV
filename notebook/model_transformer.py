...
def encode_original(original):
    original = np.array([len(input_id)] +                list(map(lambda x:input_id.setdefault(x,1), original))                + [len(input_id)+1], dtype=np.int)
...
def encode_translation(translation):
    translation = np.array([len(target_id)] +                    list(map(lambda x:target_id.setdefault(x,1), translation))                    + [len(target_id)+1], dtype=np.int)
